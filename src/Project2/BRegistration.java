...
2- BRegistration isminde bir class oluşturun ve register isminde bir metod
ekleyerek Kullanıcıdan user ismini alarak ArrayList e ekleyin

3-CListing isminde bir class oluşturun ve printHappyUsers isminde bir metod ekleyerek
ArrayListteki userlardan her ayın ilk 10 gününde kaydolanları yazdıran metodu oluşturun.

*/
    ArrayList<AUser> usersList = new ArrayList<>();
    ...
    void register() {
        ...
        AUser user = new AUser(isim, rndTarih());
        usersList.add(user);
